...
import { ProgramInsertAsyncAction, ProgramUpdateAsyncAction, ProgramDeleteAsyncAction} from "../../../../src/program/Queries";
import {ProgramMediumEditableContent} from "../../../../src/program/Components/ProgramMediumEditableContent";
...
export const GuarrantButton = ({ operation, children, guarant, onDone = () => {}, ...props }) => {
    const operationConfig = {
        C: {
            ...
            renderContent: () => <GuarrantMediumEditableContent/>,
        },
